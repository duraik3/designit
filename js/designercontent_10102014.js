...
$(document).ready(function() {
    ...
    currentcanvas = new fabric.Canvas('canvaseditor');
    ...
    if (templateURL != '') loadSVGTemplate(templateURL);
...
function changeSizeCanvas(width, height) {
    ...
    var canvasDOM = document.getElementById('canvaseditor');
    ...
    var elem = document.getElementsByClassName('upper-canvas')[0];
    ...
    var elem = document.getElementsByClassName('canvas-container')[0];
    elem.style.width = mm2pixel(width) + "px";
    elem.width = mm2pixel(width);
    elem.style.height = mm2pixel(height) + "px";
    elem.height = mm2pixel(height);
